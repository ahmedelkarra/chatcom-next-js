...
function Footer() {
    return (
        <footer
            className="w-full flex flex-col items-center bg-zinc-50 text-center text-surface dark:bg-neutral-700 dark:text-white">
            ...
            <div className="w-full bg-black/5 p-4 text-center">© {new Date().getFullYear()} Copyright: <a href="https://github.com/ahmedelkarra?tab=repositories" target='_blank'>Ahmed Aly</a>
            </div>
        </footer>
    )
}
